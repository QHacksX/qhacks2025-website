  ...
  return (
    <nav className='fixed w-full h-auto z-50'>
      <div className='flex flex-row justify-center items-center mt-10'>
        <div className='flex flex-row items-left justify-left absolute px-8 bg-brand-card-bg/90 rounded-full'>
          <motion.span
            className='hover:cursor-pointer lg:text-2xl sm:p-2 lg:p-4 font-bold text-white'
            whileHover={{ scale: 1.1, color: "#EE4036" }}
            whileTap={{ scale: 0.9 }}
          >
          ...
          <motion.span
            ...
            whileTap={{ scale: 0.9 }}
          >
            <ScrollIntoView selector='#sponsors'>Sponsors</ScrollIntoView>
          </motion.span>
          <motion.span
            className='hover:cursor-pointer lg:text-2xl sm:p-2 lg:p-4 font-bold text-white'
            whileHover={{ scale: 1.1, color: "#EE4036" }}
